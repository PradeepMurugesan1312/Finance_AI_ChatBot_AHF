...
FINANCE_DOMAINS: tuple[FinanceDomain, ...] = (
    FinanceDomain(
        ...
        example_questions=(
            ...
            "How many invoices were posted in fiscal period 5?",
            "How many invoices are overdue for payment right now?",
            "Which invoices for vendor 100000 are still unpaid?",
            "What's our largest unpaid invoice for company code 1710?",
    ...
    FinanceDomain(
        ...
        example_questions=(
            ...
            "Count of purchase orders created last week.",
            "How many purchase requisitions were raised this month?",
            "How many POs are still pending approval right now?",
            "How many purchase orders were created for vendor Cosmo Energy Holdings this year?",
        ),
    ...
    FinanceDomain(
        ...
        example_questions=(
            ...
            "How many goods receipts were posted against open POs this week?",
            "How many POs have no goods receipt yet, even though they're past their delivery date?",
        ),
        kb_docs=("po_approval_thresholds.md",),
    ),
    FinanceDomain(
    ...
    FinanceDomain(
        ...
        example_questions=(
            ...
            "How many new vendors were onboarded this quarter?",
            "How many vendors are currently blocked for posting or purchasing?",
        ),
    ...
    FinanceDomain(
        ...
        example_questions=(
            ...
            "How many open (uncleared) items exist for company code 1000 right now?",
